    ...
    <main className="min-h-screen">
      <section className="bg-primary text-primary-foreground py-12 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <p className="text-secondary font-sans uppercase tracking-[0.3em] text-sm mb-2">Administration</p>
          <h1 className="font-serif text-3xl md:text-4xl font-bold">Product Manager</h1>
        </motion.div>
      </section>

      <div className="container mx-auto px-4 py-10">
        <p className="text-sm text-muted-foreground font-sans mb-6">
          Logged in as <span className="font-bold">{user.email}</span>. Edit products below.
        </p>
              ...
              {editingId === product.id ? (
                <div className="space-y-3">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    <div>
                      <label className="text-xs font-sans font-bold text-muted-foreground">Title</label>
                    ...
                    <div>
                      <label className="text-xs font-sans font-bold text-muted-foreground">Price (€)</label>
                    ...
                    <div>
                      <label className="text-xs font-sans font-bold text-muted-foreground">Stock</label>
                  ...
                  <div>
                    <label className="text-xs font-sans font-bold text-muted-foreground">Short Description</label>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-muted-foreground font-sans">€{product.price.toFixed(2)} · {product.stockCount} in stock</p>
                  </div>
